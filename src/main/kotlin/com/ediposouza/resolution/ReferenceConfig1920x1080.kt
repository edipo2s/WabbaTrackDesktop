...
class ReferenceConfig1920x1080 : ReferenceConfig() {
    ...
    override val BASE_CARD_HEIGHT = 192
    override val BASE_CARD_WIDTH = 170
    ...
    override val SCREEN_DECK_BUILDER_X = 1615
    override val SCREEN_DECK_BUILDER_Y = 1000
    override val SCREEN_DECK_BUILDER_HEIGHT = 80
    override val SCREEN_DECK_BUILDER_WIDTH = 50

    override val SCREEN_DECK_BUILDER_EMPTY_X = 1615
    override val SCREEN_DECK_BUILDER_EMPTY_Y = 952
    override val SCREEN_DECK_BUILDER_EMPTY_HEIGHT = 49
    override val SCREEN_DECK_BUILDER_EMPTY_WIDTH = 128
    ...
    override val GAME_CARD_DRAW_PROPHECY_HEIGHT = 144
    ...
    override val GAME_PLAYER_FIRST_X = 1294
    override val GAME_PLAYER_FIRST_Y = 160

    override val GAME_PLAYER_SECOND_HEIGHT = 74
    override val GAME_PLAYER_SECOND_WIDTH = 76
    override val GAME_PLAYER_SECOND_X = 1362
    override val GAME_PLAYER_SECOND_Y = 773
    ...
    override val ARENA_PICK_CARD_START_Y = 213
    override val ARENA_PICK_CARD_FIRST_X = 397
    override val ARENA_PICK_CARD_SECOND_X = 715
    override val ARENA_PICK_CARD_THIRD_X = 1038
    ...
    override val DECK_BUILDER_CLEAR_FILTER_MAGICKA_0_X = 135
    override val DECK_BUILDER_CLEAR_FILTER_MAGICKA_0_Y = 1045
    override val DECK_BUILDER_CLEAR_FILTER_MAGICKA_1_X = 200
    ...
    override val DECK_BUILDER_CLEAR_FILTER_SET_X = 760
    ...
    override val DECK_BUILDER_CLEAR_FILTER_SET_ALL_Y = 770
    override val DECK_BUILDER_CLEAR_FILTER_RARITY_X = 670
    ...
    override val DECK_BUILDER_CLEAR_FILTER_RARITY_ALL_Y = 780
    override val DECK_BUILDER_CLEAR_CARDS_FIRST_CARD_X = 1750
    override val DECK_BUILDER_CLEAR_CARDS_FIRST_CARD_Y = 130

    override val DECK_BUILDER_SEARCH_FIELD_X = 650
    override val DECK_BUILDER_SEARCH_FIELD_Y = 40
    override val DECK_BUILDER_FIRST_LINE_CLICK_CARD_X = 210
    override val DECK_BUILDER_FIRST_LINE_CLICK_CARD_DISTANCE_X = 300
    override val DECK_BUILDER_FIRST_LINE_CLICK_CARD_Y = 280

    override val DECK_BUILDER_DECK_COVER_X = 1730
    override val DECK_BUILDER_DECK_COVER_Y = 50
    override val DECK_BUILDER_DECK_COVER_CONFIRM_X = 960
    override val DECK_BUILDER_DECK_COVER_CONFIRM_Y = 880

    override val DECK_BUILDER_CARD_HEIGHT = 180
    override val DECK_BUILDER_CARD_WIDTH = 158
    override val DECK_BUILDER_CARD_1_X = 130
    override val DECK_BUILDER_CARD_2_X = 430
    override val DECK_BUILDER_CARD_3_X = 728
    override val DECK_BUILDER_CARD_4_X = 1026
    override val DECK_BUILDER_CARD_5_X = 1325
    override val DECK_BUILDER_FIRST_LINE_CARD_Y = 158
    override val DECK_BUILDER_SECOND_LINE_CARD_Y = 618

    override val DECK_BUILDER_NONE_LEFT_HEIGHT = 30
    override val DECK_BUILDER_NONE_LEFT_WIDTH = 47
    override val DECK_BUILDER_NONE_LEFT_LINE_CARD_1_X = 119
    override val DECK_BUILDER_NONE_LEFT_LINE_CARD_2_X = 418
    override val DECK_BUILDER_NONE_LEFT_LINE_CARD_3_X = 717
    override val DECK_BUILDER_NONE_LEFT_LINE_CARD_4_X = 1015
    override val DECK_BUILDER_NONE_LEFT_LINE_CARD_5_X = 1314
    override val DECK_BUILDER_NONE_LEFT_LINE_CARD_Y = 477
